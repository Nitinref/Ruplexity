...
export class QdrantService {
  ...
  async indexWebResults(results: any[], collectionName: string = 'web_search_cache') {
  ...
  async indexPDFContent(content: string, metadata: any, collectionName: string = 'pdf_documents') {
    await this.ensureCollection(collectionName);
